    ...
    [
        {
            ...
            github_link: "https://github.com/dropaiorg", //GitHub Org
            tech: [
    ...
    return (
        <section id="projects">
            <main className="flex flex-col justify-center items-center py-20">
                ...
                <div className="w-full max-w-6xl px-6 mt-10 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-10 items-stretch auto-rows-fr">
